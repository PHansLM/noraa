...
const registroAvistamiento: React.FC = () => {
    ...
    const [buttonText, setButtonText] = useState<string>("Seleccionar Imagenes");
    const [buttonColor, setButtonColor] = useState<string>("bg-gray-100");
                            ...
                            <div className="w-full flex-1 mt-7">
                                <div className="mx-auto max-w-xs">
                                    ...
                                    <div className="mt-5">
                                       ...
                                       <label
                                           htmlFor="logoInput"
                                           className={`ml-16 mt-7 cursor-pointer inline-block ${buttonColor} border border-black text-black px-4 py-2 rounded-lg transition duration-300 ease-in-out hover:bg-blue-200`}
                                        >
                                             {buttonText}
                                       </label>
                                       <input
